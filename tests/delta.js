		...
		},
		{
			...
			tests: [
				...
				},
				{
					...
					args: [
						"lab(50% 2.4900 -0.0010)",
						"lab(50% -2.4900 0.0009)",
					],
					expect: 7.1792,
				},
				{
				...
				},
				{
					...
					args: [
						"lab(50% -0.0010 2.4900)",
						"lab(50% 0.0009 -2.4900)",
					],
					expect: 4.8045,
				},
				{
