...
[Color.js has now been downloaded over 113 million times on npm!](https://limonte.dev/total-npm-downloads/?package=colorjs.io)
The rate of increase is still accelerating, currently at 3.5 million downloads **per week**!
We even had to automate updating the number in our README so we could have a chance to keep up ([thanks @MysteryBlokHed!](https://github.com/color-js/color.js/pull/610)).
...
Once there are enough sponsors, we plan to feature them prominently on our website and README.
...
Color Elements were originally developed for our own [apps](#color-apps) and [the Color Palettes project](#color-palettes), so these projects also serve as demos for them.
...
- Testsuite & test coverage improvements (by @lloydk in #480 #481 #482 #483 #484 #489 #490 #500 #543 #556 #565 #569, @epsilonError in #559 #594, @kleinfreund in #616, and @svgeesus in f02ce7f)
