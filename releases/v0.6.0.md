...
- API docs that are actually up to date, using [Typedoc](https://typedoc.org/)! You can find them at [colorjs.io/api](https://colorjs.io/api) (by @leaverou with help from @MysteryBlokHed in #498 #497 #549)
...
- `colorSpace.isUnbounded` property (by @lloydk in #503)
